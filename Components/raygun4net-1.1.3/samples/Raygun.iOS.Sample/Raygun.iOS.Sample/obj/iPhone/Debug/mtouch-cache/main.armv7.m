...
extern void *mono_aot_module_RayguniOSSample_info;
...
{
	mono_aot_register_module (mono_aot_module_RayguniOSSample_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "RayguniOSSample.exe";
	mono_use_llvm = FALSE;
