...
void *
native_to_managed_trampoline_Raygun_iOS_Sample_AppDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Raygun_iOS_Sample_AppDelegate_FinishedLaunching (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Raygun_iOS_Sample_MyViewController__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Raygun_iOS_Sample_MyViewController_ViewDidLoad (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"AppDelegate", "Raygun.iOS.Sample.AppDelegate, RayguniOSSample", 0},
	...
	{"Raygun.iOS.Sample.MyViewController", "Raygun.iOS.Sample.MyViewController, RayguniOSSample", 0},
...
static MTClass __monotouch_classes [] = {
	...
	{"Raygun.iOS.Sample.MyViewController", "UIViewController", 1, 2, 0},
};
...
static MTMethod __monotouch_methods [] = {
	...
	{"init","@@:",0, &native_to_managed_trampoline_Raygun_iOS_Sample_AppDelegate__ctor},
	{"application:didFinishLaunchingWithOptions:","B@:@@",0, &native_to_managed_trampoline_Raygun_iOS_Sample_AppDelegate_FinishedLaunching},
	{"init","@@:",0, &native_to_managed_trampoline_Raygun_iOS_Sample_MyViewController__ctor},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_Raygun_iOS_Sample_MyViewController_ViewDidLoad},
};

static MTProperty __monotouch_properties [] = {
};

int __monotouch_map_count = 23;
