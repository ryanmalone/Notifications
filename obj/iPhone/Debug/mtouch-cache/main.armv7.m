...
extern void *mono_aot_module_Example_Notifications_info;
...
{
	mono_aot_register_module (mono_aot_module_Example_Notifications_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "Example_Notifications.exe";
	mono_use_llvm = FALSE;
